...
export function ReviewCard(props) {
  return (
    <div className="flex flex-col relative gap-2 border-2 border-dashed border-lime-500/50 py-2 px-4 rounded-xl md:w-[90%] bg-white/70 transition-all transition-300">
